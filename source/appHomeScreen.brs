...
'**********************************************************
Function displayBundleScreen(bundle As Object) As Dynamic

    if validateParam(bundle, "roAssociativeArray", "displayBundleScreen") = false return -1
    screen = preShowPosterScreen(bundle.title, "")
    showPosterScreen(screen, bundle)
...
'**********************************************************
Function displayPackageScreen() As Dynamic
...
'************************************************************
Function initPackageList() As Void

    conn = InitPackageFeedConnection()
